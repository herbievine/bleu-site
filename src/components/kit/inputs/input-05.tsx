  ...
  return (
    <div className="w-full flex flex-col space-y-2">
      ...
      <input
        ...
        type="text"
        className="w-full px-3 py-1.5 text-red-500 border border-red-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-offset-2 ring-red-300"
      />
