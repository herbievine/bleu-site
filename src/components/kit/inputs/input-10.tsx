    ...
    <div className="w-full flex flex-col space-y-2">
      ...
      <div className="group w-full flex">
        <input
          ...
          type="text"
          className="w-full px-3 py-1.5 outline-none border border-slate-300 hover:border-slate-400 transition-colors duration-200 focus-visible:ring-1 ring-offset-2 ring-slate-500 z-10"
        />
